...
import { getHRPendingApprovals } from "@/lib/leave/mockLeaveData";
import { AlertCircle, Calendar, CheckCircle, Clock, FileText, PieChart, Users, CalendarDays, Building } from "lucide-react";
...
export default function HRDashboardPage() {
  ...
  useEffect(() => {
    if (!loading && (!user || user.role.toLowerCase() !== "hr")) {
      if (!user) {
        router.push("/login");
      } else {
  ...
  const pendingApprovals = getHRPendingApprovals();
